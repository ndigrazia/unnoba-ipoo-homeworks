...
import clima.interfaz.panel.BotonPanel;
import clima.interfaz.panel.LogPanel;
import clima.modelo.Clima;
import clima.modelo.EstaciónMeteorológica;

public class ClimaGui implements Observer {

	private EstaciónMeteorológica estacion = new EstaciónMeteorológica();
